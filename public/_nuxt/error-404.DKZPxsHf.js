...
const g = (t) => (h('data-v-73a07988'), (t = t()), f(), t),
  b = {
    class:
  ...
  x = g(() =>
    e('div', { class: 'fixed left-0 right-0 spotlight z-10' }, null, -1)
  ),
  m = { class: 'max-w-520px text-center z-20' },
  y = ['textContent'],
  _ = ['textContent'],
  k = { class: 'w-full flex items-center justify-center' },
  w = {
    __name: 'error-404',
    props: {
              ...
              e('div', m, [
                ...
                e('div', k, [
                  c(
                    ...
                    { default: d(() => [l(o(t.backHome), 1)]), _: 1 }
                  )
                ])
              ])
            ])
  ...
  C = r(w, [['__scopeId', 'data-v-73a07988']]);
export { C as default };
